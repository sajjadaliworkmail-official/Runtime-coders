    ...
    const features = [
        {
            ...
            description: "Instant scanning and risk assessment of URLs and messages without delays.",
            icon: (
        ...
        },
        {
            ...
            description: "Detailed, human-readable reasons for each risk assessment to educate users.",
            icon: (
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        },
        {
            ...
            description: "Visual risk indicators with green, yellow, and red badges for quick understanding.",
            icon: (
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        },
        {
            ...
            description: "Simple, intuitive interface designed for users with no technical background.",
            icon: (
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
